...
Bot.on('message', (message) => {
    ...
    if (message.content == '!blockcount' || message.content == '!Blockcount' || message.content == '!block' || message.content == '!Block' || message.content == '!blocks' || message.content == '!Blocks') {
        Comands.GetBlockCount(message);
    }

    if (message.content == '!fund' || message.content == '!Fund' || message.content == '!donations' || message.content == '!Donations' || message.content == '!fundraiser' || message.content == '!Fundraiser') {
       Comands.GetFund(message);
    }

    if (message.content == '!hash' || message.content == '!Hash' || message.content == '!hashrate' || message.content == '!Hashrate') {
        Comands.GetHashrate(message);
    }

    if (message.content == '!market' || message.content == '!Market' || message.content == '!price' || message.content == '!Price') {
       Comands.GetPrice(message);
    }
    
    if (message.content == '!masternodes' || message.content == '!Masternodes' || message.content == '!masternode' || message.content == '!Masternode') {
         Comands.GetMasternodesCount(message);
    }

    if(message.content == '!rewards' || message.content == '!Rewards' || message.content == '!reward' || message.content == '!Reward'){
    ...
    if (message.content == '!guide' || message.content == '!Guide') {
    ...
    if (message.content == '!takeoverworld') {
        //message.channel.send('World Domination Is Mine! :P');
